  ...
  .auth-layout {
    ...
    .form {
      &__title {
        ...
        text-align: center;
        text-shadow: -1px 2px 4px #0000008c;
      }
      ...
      &__auth {
        ...
        button[type='submit'] {
          ...
          &:hover {
            ...
            background-color: #5f9ea0;
            box-shadow: inset 0 3px 10px 0 #00000059;
          }
